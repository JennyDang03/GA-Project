-- TED intramunicipio por municipio , dia e tipo de pessoa
SELECT
		HIL_DT_MOVTO as dia,
	...
	GROUP BY cadastroReceitaDEB.CODIGO_DO_MUNICIPIO_NO_BCBASE , HIL_DT_MOVTO, [LIF_CD_TP_PES_CRED], [LIF_CD_TP_PES_DEB] 
