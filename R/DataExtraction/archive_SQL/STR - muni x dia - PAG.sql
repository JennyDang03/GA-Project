-- TED por municipio PAGADOR, dia e tipo de pessoa
SELECT
		HIL_DT_MOVTO as dia,
		cadastroReceita.CODIGO_DO_MUNICIPIO_NO_BCBASE as muni_PAG,
	...
	ON tableSTRDetails.[LIF_CD_CNPJCPFDEB1] COLLATE DATABASE_DEFAULT = cadastroReceita.CODIGO_CNPJ_14	
	WHERE 
