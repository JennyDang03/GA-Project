...
-- PEJ_IB_MATRIZ = 1 -- cnpj8 = MATRIZ, cnpj14 = FILIAL
-- PEJ_DT_ABERTURA as open_date,
--(CASE WHEN EMPRESA.SPJ_CD_SITUACAO_PJ_RFB IN (8,3,4) THEN EMPRESA.PEJ_DT_ALTERACAO_SITUACAO ELSE NULL END) AS close_date
-- 8 = baixada, 3 = suspensa, 4 = inapta - open_date < '2024-01-01' AND (close_date IS NULL OR close_date > '2018-01-01')
),
ID_list AS (
