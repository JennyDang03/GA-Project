-- Pix_ind_sample_month_PJ
-- Variables: time_id, id, id_municipio_receita, tipo, value_send, trans_send, value_rec, trans_rec, value_self, trans_self
...
MAIN_send AS (
    ...
    WHERE 
        ...
        AND A.TPP_CD_TIPO_PESSOA_PAGADOR = 2
...
MAIN_rec AS (
    ...
    WHERE 
        ...
        AND  A.STA_CD_REJEICAO = 'N'
        AND A.PES_NU_CPF_CNPJ_PAGADOR <> A.PES_NU_CPF_CNPJ_RECEBEDOR
        AND A.TPP_CD_TIPO_PESSOA_RECEBEDOR = 2
