...
dat_flood_month[, time_id_treated := ifelse(treat==0, 10000, date_flood_month)]
...
# 3. Load PIX_week_muni_self_flood.dta
...
#PF
iv_function_month("hhi_total_deposits","HHI Deposits","log_n_cli_pag_pf", "Log Quantity of People Sending Pix","after_flood",merged_data)
iv_function_month("hhi_poupanca","HHI Savings","log_n_cli_pag_pf", "Log Quantity of People Sending Pix","after_flood",merged_data)
iv_function_month("hhi_dep_prazo","HHI Time Deposits","log_n_cli_pag_pf", "Log Quantity of People Sending Pix","after_flood",merged_data)
iv_function_month("hhi_dep_vista_PF","HHI Checking Account of People","log_n_cli_pag_pf", "Log Quantity of People Sending Pix","after_flood",merged_data)

#THEN DO PJ
iv_function_month("hhi_dep_vista_PJ","HHI Checking Account of Firms","log_n_cli_pag_pj", "Log Quantity of Firms Sending Pix","after_flood",merged_data)
