...
graph_function18 <- function(y,dat,xlimit_l,xlimit_u, main_title){
  png(file.path(output_path,paste0("credito_flood_",y,"nocontrol.png")), width = 640*4, height = 480*4, res = 200)
  ...
  # png(file.path(output_path,paste0("credito_flood_",y,"control.png")), width = 640*4, height = 480*4, res = 200)
  ...
  png(file.path(output_path,paste0("credito_flood_",y,"control1.png")), width = 640*4, height = 480*4, res = 200)
...
graph_function19 <- function(y,dat,xlimit_l,xlimit_u, main_title){
  png(file.path(output_path,paste0("before_pix_credito_flood_",y,"nocontrol.png")), width = 640*4, height = 480*4, res = 200)
  iplot(graph_function9(y,dat), sep = 0.5, ref.line = -1,
        xlab = 'Month',
        main = main_title,
        ci_level = 0.95, xlim = c(xlimit_l-0.5,xlimit_u+0.5))
  ...
  # png(file.path(output_path,paste0("before_pix_credito_flood_",y,"control.png")), width = 640*4, height = 480*4, res = 200)
  # iplot(graph_function15(y,dat), sep = 0.5, ref.line = -1,
  #       xlab = 'Month',
  #       main = main_title,
  #       ci_level = 0.95, xlim = c(xlimit_l-0.5,xlimit_u+0.5))
  ...
  png(file.path(output_path,paste0("before_pix_credito_flood_",y,"control1.png")), width = 640*4, height = 480*4, res = 200)
  iplot(graph_function16(y,dat), sep = 0.5, ref.line = -1,
        xlab = 'Month',
        main = main_title,
        ci_level = 0.95, xlim = c(xlimit_l-0.5,xlimit_u+0.5))
...
graph_function18("log_vol_cartao",dat_flood, xlimit_low, xlimit_up, "Log Volume Credit Card")
graph_function18("log_qtd_cli_cartao",dat_flood, xlimit_low, xlimit_up, "Log Quantity Credit Card")
graph_function18("log_vol_emprestimo_pessoal",dat_flood, xlimit_low, xlimit_up, "Log Volume Personal Loan")
graph_function18("log_qtd_cli_emp_pessoal",dat_flood, xlimit_low, xlimit_up, "Log Quantity Personal Loan")
graph_function18("log_vol_credito_total",dat_flood, xlimit_low, xlimit_up, "Log Volume Loan")
graph_function18("log_qtd_cli_total",dat_flood, xlimit_low, xlimit_up, "Log Quantity Loan")
graph_function18("log_vol_credito_total_PF",dat_flood, xlimit_low, xlimit_up, "Log Volume Loan")
graph_function18("log_qtd_cli_total_PF",dat_flood, xlimit_low, xlimit_up, "Log Quantity Loan")
graph_function18("log_vol_credito_total_PJ",dat_flood, xlimit_low, xlimit_up, "Log Volume Loan")
graph_function18("log_qtd_cli_total_PJ",dat_flood, xlimit_low, xlimit_up, "Log Quantity Loan")
...
graph_function19("log_vol_cartao",dat_flood, xlimit_low, xlimit_up, "Log Volume Credit Card")
graph_function19("log_qtd_cli_cartao",dat_flood, xlimit_low, xlimit_up, "Log Quantity Credit Card")
graph_function19("log_vol_emprestimo_pessoal",dat_flood, xlimit_low, xlimit_up, "Log Volume Personal Loan")
graph_function19("log_qtd_cli_emp_pessoal",dat_flood, xlimit_low, xlimit_up, "Log Quantity Personal Loan")
graph_function19("log_vol_credito_total",dat_flood, xlimit_low, xlimit_up, "Log Volume Loan")
graph_function19("log_qtd_cli_total",dat_flood, xlimit_low, xlimit_up, "Log Quantity Loan")
graph_function19("log_vol_credito_total_PF",dat_flood, xlimit_low, xlimit_up, "Log Volume Loan")
graph_function19("log_qtd_cli_total_PF",dat_flood, xlimit_low, xlimit_up, "Log Quantity Loan")
graph_function19("log_vol_credito_total_PJ",dat_flood, xlimit_low, xlimit_up, "Log Volume Loan")
graph_function19("log_qtd_cli_total_PJ",dat_flood, xlimit_low, xlimit_up, "Log Quantity Loan")
