...
#flood_flow_banco_muni_self_v2.R
...
graph_function_pfandpj <- function(y,dat,xlimit_l,xlimit_u, main_title){
  #PF
  png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_PFnocontrol.png")), width = 640*4, height = 480*4, res = 200)
  ...
  # png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_PFcontrol.png")), width = 640*4, height = 480*4, res = 200)
  ...
  png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_PFcontrol1.png")), width = 640*4, height = 480*4, res = 200)
  ...
  dev.off()
  #PJ
  png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_PJnocontrol.png")), width = 640*4, height = 480*4, res = 200)
  ...
  # png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_PJcontrol.png")), width = 640*4, height = 480*4, res = 200)
  ...
  png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_PJcontrol1.png")), width = 640*4, height = 480*4, res = 200)
...
graph_function_collapse <- function(y,dat,xlimit_l,xlimit_u, main_title){
  png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_nocontrol.png")), width = 640*4, height = 480*4, res = 200)
  ...
  # png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_control.png")), width = 640*4, height = 480*4, res = 200)
  ...
  png(file.path(output_path,paste0("banco_muni_self_flood_",y,"_control1.png")), width = 640*4, height = 480*4, res = 200)
...
graph_function_pfandpj("log_valor_self_totalflow",dat_flood, xlimit_low, xlimit_up, "Log Flow Value")
graph_function_pfandpj("log_qtd_self_totalflow",dat_flood, xlimit_low, xlimit_up, "Log Flow Transaction")

graph_function_pfandpj("valor_self_netflow",dat_flood, xlimit_low, xlimit_up, "NetFlow Value")
graph_function_pfandpj("qtd_self_netflow",dat_flood, xlimit_low, xlimit_up, "NetFlow Transaction")
...
# Load already prepared data!
dat_flood <- read_dta(file.path(dta_path,"Base_muni_banco_self_flood_collapsed3.dta"))
mun_fe <- read_dta(file.path(dta_path, "mun_fe.dta"))
dat_flood <- merge(dat_flood, mun_fe)
# converts to data.table
setDT(dat_flood)
...
graph_function_collapse("log_valor_self_totalflow",dat_flood, xlimit_low, xlimit_up, "Log Flow Value")
graph_function_collapse("log_qtd_self_totalflow",dat_flood, xlimit_low, xlimit_up, "Log Flow Transaction")

graph_function_collapse("valor_self_netflow",dat_flood, xlimit_low, xlimit_up, "NetFlow Value")
graph_function_collapse("qtd_self_netflow",dat_flood, xlimit_low, xlimit_up, "NetFlow Transaction")

##############################################################################
##############################################################################
# Do the whole collapse (Digital + Traditional)

# Nothing new here. No need to do this
##############################################################################
##############################################################################
