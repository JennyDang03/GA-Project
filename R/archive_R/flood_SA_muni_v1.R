...
graph_function5 <- function(y,dat,xlimit_l,xlimit_u,ylimit_l,ylimit_u, main_title){
...
graph_function4("log_valor_PIX_inflow",dat_flood, -12, 24, -0.05, 0.09, "Log Value Pix Inflow")
graph_function4("log_valor_PIX_outflow",dat_flood, -12, 24, -0.05, 0.09, "Log Value Pix Outflow")
graph_function4("log_valor_PIX_intra",dat_flood, -12, 24, -0.05, 0.09, "Log Value Pix Intra")

graph_function4("log_qtd_PIX_inflow",dat_flood, -12, 24, -0.05, 0.09, "Log Transactions Pix Inflow")
graph_function4("log_qtd_PIX_outflow",dat_flood, -12, 24, -0.05, 0.09, "Log Transactions Pix Outflow")
graph_function4("log_qtd_PIX_intra",dat_flood, -12, 24, -0.05, 0.09, "Log Transactions Pix Intra")
...
graph_function4("log_n_cli_pag_pf_intra",dat_flood, -12, 24, -0.05, 0.09, "Log Quantity of People Sending Pix")
graph_function4("log_n_cli_rec_pf_intra",dat_flood, -12, 24, -0.05, 0.09, "Log Quantity of People Receiving Pix") #
...
#graph_function5("valor_TED_intra",dat_flood, -12, 24, -100000, 220000, "Value TED Intra") # 
#graph_function5("qtd_TED_intra",dat_flood, -12, 24, -4, 3, "Transactions TED Intra") #

graph_function5("log_valor_TED_intra",dat_flood, -12, 24, -0.40, 0.18, "Log Value TED Intra") #
graph_function5("log_qtd_TED_intra",dat_flood, -12, 24, -0.20, 0.15, "Log Transactions TED Intra") #

#graph_function5("qtd_cli_TED_rec_PJ",dat_flood, -12, 24, -0.15, 0.6, "Quantity of Firms Receiving TED") #
#graph_function5("qtd_cli_TED_pag_PJ",dat_flood, -12, 24, -0.15, 0.6, "Quantity of Firms Sending TED") # 

graph_function5("log_qtd_cli_TED_rec_PJ",dat_flood, -12, 24, -0.04, 0.1, "Log Quantity of Firms Receiving TED")
graph_function5("log_qtd_cli_TED_pag_PJ",dat_flood, -12, 24, -0.04, 0.1, "Log Quantity of Firms Sending TED")

#graph_function5("qtd_cli_TED_rec_PF",dat_flood, -12, 24, "Quantity of People Receiving TED")
#graph_function5("qtd_cli_TED_pag_PF",dat_flood, -12, 24, "Quantity of People Sending TED")
#graph_function5("log_qtd_cli_TED_rec_PF",dat_flood, -12, 24, -0.05, 0.1, "Log Quantity of People Receiving TED") #
#graph_function5("log_qtd_cli_TED_pag_PF",dat_flood, -12, 24, -0.05, 0.1, "Log Quantity of People Sending TED") #


#Boleto
# * valor_boleto qtd_boleto qtd_cli_pag_pf_boleto qtd_cli_pag_pj_boleto qtd_cli_rec_pj_boleto 
#graph_function5("valor_boleto",dat_flood, -12, 24, -6500000, 6500000, "Value Boleto")
#graph_function5("qtd_boleto",dat_flood, -12, 24, -200, 300, "Transactions Boleto")

graph_function5("log_valor_boleto",dat_flood, -12, 24, -0.05, 0.15, "Log Value Boleto")
graph_function5("log_qtd_boleto",dat_flood, -12, 24, -0.03, 0.06, "Log Transactions Boleto")


#Cartao 
# * valor_cartao_credito valor_cartao_debito qtd_cli_cartao_debito qtd_cli_cartao_credito 
#graph_function5("valor_cartao_credito",dat_flood, -12, 24, -40000, 50000, "Value Credit Card")
#graph_function5("valor_cartao_debito",dat_flood, -12, 24, -50000, 100000, "Value Debit Card")

graph_function5("log_valor_cartao_debito",dat_flood, -12, 24, -0.04, 0.08, "Log Value Debit Card")
graph_function5("log_valor_cartao_credito",dat_flood, -12, 24, -0.04, 0.08, "Log Value Credit Card")

#graph_function5("qtd_cli_cartao_credito",dat_flood, -12, 24, -2, 2.5, "Quantity of People using Credit Card")
#graph_function5("qtd_cli_cartao_debito",dat_flood, -12, 24, -4, 6, "Quantity of People using Debit Card")

graph_function5("log_qtd_cli_cartao_debito",dat_flood, -12, 24, -0.03, 0.04, "Log Quantity of People using Debit Card")
graph_function5("log_qtd_cli_cartao_credito",dat_flood, -12, 24, -0.03, 0.04, "Log Quantity of People using Credit Card")
