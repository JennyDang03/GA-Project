...
# PJ
graph_function5("log_valor_totalflow",dat_flood, xlimit_low, xlimit_up, "Log Flow Value")
graph_function5("log_qtd_totalflow",dat_flood, xlimit_low, xlimit_up, "Log Flow Transaction")
# PF
graph_function4("log_valor_totalflow",dat_flood, xlimit_low, xlimit_up, "Log Flow Value")
graph_function4("log_qtd_totalflow",dat_flood, xlimit_low, xlimit_up, "Log Flow Transaction")


# PJ
graph_function5("valor_netflow",dat_flood, xlimit_low, xlimit_up, "NetFlow Value")
graph_function5("qtd_netflow",dat_flood, xlimit_low, xlimit_up, "NetFlow Transaction")
# PF
graph_function4("valor_netflow",dat_flood, xlimit_low, xlimit_up, "NetFlow Value")
graph_function4("qtd_netflow",dat_flood, xlimit_low, xlimit_up, "NetFlow Transaction")
