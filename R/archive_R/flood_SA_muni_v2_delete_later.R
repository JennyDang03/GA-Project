...
graph_function44 <- function(y,dat,xlimit_l,xlimit_u, main_title){
  png(file.path(output_path,paste0("muni_pix_flood_",y,"_extended.png")), width = 640*4, height = 480*4, res = 200)
  iplot(graph_function3(y,dat), sep = 0.5, ref.line = -1,
        xlab = 'Week',
        main = main_title,
        ci_level = 0.90, xlim = c(xlimit_l,xlimit_u))
...
graph_function44("log_n_cli_pag_pj",dat_flood, xlimit_low, xlimit_up, "Log Quantity of Firms Sending Pix")

dat_flood[, log_n_cli_rec_pj := log((n_cli_rec_pj_inflow + n_cli_rec_pj_intra) + 1)]
graph_function44("log_n_cli_rec_pj",dat_flood, xlimit_low, xlimit_up, "Log Quantity of Firms Receiving Pix")
