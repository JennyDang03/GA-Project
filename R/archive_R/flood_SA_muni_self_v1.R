...
dat_flood <- read_dta(file.path(dta_path,"PIX_week_muni_self_flood_sample10.dta"))
...
graph_function4("log_valor_self_pj",dat_flood, -12, 24, -0.65, 0.5, "Log Value")
graph_function4("log_qtd_self_pj",dat_flood, -12, 24, -0.2, 0.15, "Log Transactions")
graph_function4("log_n_cli_self_pj",dat_flood, -12, 24, -0.1, 0.1, "Log Quantity of Firms")
...
graph_function4("log_valor_self_pf",dat_flood, -12, 24, -0.10, 0.09, "Log Value")
graph_function4("log_qtd_self_pf",dat_flood, -12, 24, -0.04, 0.04, "Log Transactions")
graph_function4("log_n_cli_self_pf",dat_flood, -12, 24, -0.04, 0.04, "Log Quantity of People")
