...
log_file <- file.path(log_path, "flood_SA_individual_v1.log")
...
graph_function2 <- function(y,dat,xlimit_l, xlimit_u, ylimit_l,ylimit_u, main_title){
  png(file.path(output_path,paste0("pix_flood_",y,".png")), width = 640*4, height = 480*4, res = 200)
...
dat_flood <- read_dta(file.path(dta_path,"Pix_individuo_cleaned1_sample1.dta"))
...
graph_function2("after_first_pix_rec",dat_flood, -6, 6, -0.006, 0.009, "Receiver Adoption")
graph_function2("after_first_pix_sent",dat_flood, -6, 6, -0.006, 0.009, "Sender Adoption")

graph_function2("receiver",dat_flood, -6, 6, -0.005, 0.01, "Receiver")
graph_function2("sender",dat_flood, -6, 6, -0.005, 0.01, "Senders")
graph_function2("user",dat_flood, -6, 6, -0.005, 0.01, "Users")

graph_function2("trans_rec",dat_flood, -6, 6, -0.1, 0.3, "Transactions Received")
graph_function2("trans_sent",dat_flood, -6, 6, -0.1, 0.3, "Transactions Sent")
graph_function2("value_rec",dat_flood, -6, 6, -150, 150, "Value Received")
graph_function2("value_sent",dat_flood, -6, 6, -150, 150, "Value Sent")
...
graph_function2("log_trans_rec",dat_flood, -6, 6, -0.015, 0.025, "Log Transactions Received")
graph_function2("log_trans_sent",dat_flood, -6, 6, -0.015, 0.025, "Log Transactions Sent")
graph_function2("log_value_rec",dat_flood, -6, 6, -0.03, 0.08, "Log Value Received")
graph_function2("log_value_sent",dat_flood, -6, 6, -0.03, 0.08, "Log Value Sent")
