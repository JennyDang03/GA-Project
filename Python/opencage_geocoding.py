...
###############################################################################
api_key = "22b98c5cf0394fbaa417974bf8c5fd4c"
key = "22b98c5cf0394fbaa417974bf8c5fd4c"


#-> 'id': row[0], 'address': row[1]
# Need to format like this
# withdraw_address_cleaned_rand100.csv
#/home/mcs038/Documents/Pix_regressions/csv/location/address_normalized.dta
#infile = "C:/Users/mathe/Dropbox/RESEARCH/pix/pix-event-study/CSV/geocoding/withdraw_address_cleaned_rand100.csv"
infile = "/home/mcs038/Documents/Pix_regressions/csv/location/aux_address/30k_files/aux_address"
...
#address_normalized_cleaned_url_10
#withdraw_address_cleaned_rand100

max_items = 0         # Set to 0 for unlimited - it was 100
num_workers = 5        # For 10 requests per second try 2-5 - it was 3
timeout = 5            # For individual HTTP requests. In seconds, default is 1
retry_max_tries = 2    # How often to retry if a HTTP request times out - it was 10
retry_max_time = 10    # Limit in seconds for retries - it was 60
